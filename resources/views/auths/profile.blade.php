    ...
    <li class="list-group-item panel-body">
      <table class="table-padding">
        ...
        <tr>
          ...
          <td><a href='auth/myallposts'>Show All</a></td>
          @endif
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><a href="auth/mydrafts">Show All</a></td>
          @endif
        </tr>
      </table>
    </li>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <p>
      <strong><a href="{{ url('showpost/'.$latest_post->slug) }}">{{ $latest_post->title }}</a></strong>
...
<div class="panel panel-default">
  ...
  <div class="list-group">
    ...
    <div class="list-group-item">
      ...
      <p>On post <a href="{{ url('showpost/'.$latest_comment->post->slug) }}">{{ $latest_comment->post->title }}</a></p>
    </div>
    @endforeach
    @else
    <div class="list-group-item">
